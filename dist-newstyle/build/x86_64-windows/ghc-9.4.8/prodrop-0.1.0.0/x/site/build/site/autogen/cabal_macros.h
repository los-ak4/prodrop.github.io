...
/* package prodrop-0.1.0.0 */
#ifndef VERSION_prodrop
#define VERSION_prodrop "0.1.0.0"
#endif /* VERSION_prodrop */
#ifndef MIN_VERSION_prodrop
#define MIN_VERSION_prodrop(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_prodrop */
...
#define CURRENT_COMPONENT_ID "prodrop-0.1.0.0-inplace-site"
